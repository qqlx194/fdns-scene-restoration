...
class decodingNetwork(nn.Module):
    def __init__(self, input_channel=3, output_channels=3, down_ratio_l2=1, down_ratio_l3=1):
        ...
        self.layers = nn.Sequential(
            ...
            nn.Conv2d(input_channel, 84, kernel_size=3, stride=1, padding=1),
            nn.LeakyReLU(negative_slope=0.01, inplace=True),
            nn.InstanceNorm2d(84),
            nn.Conv2d(84, 84, kernel_size=3, stride=down_ratio_l2, padding=1),
            nn.LeakyReLU(negative_slope=0.01, inplace=True),
            nn.InstanceNorm2d(84),
            nn.Conv2d(84, output_channels, kernel_size=3, stride=down_ratio_l3, padding=1),
            nn.Sigmoid(),
